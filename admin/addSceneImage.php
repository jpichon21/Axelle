...
if (isset($_SESSION['logged_in'])) {
    if (isset($_POST['upload'])) {
        ...
        $target = "../img/contents/sliders/scene/".basename($_FILES['image']['name']);
        $thumb_target = "../img/contents/sliders/scene/thumbs/".basename($_FILES['thumbnail']['name']);
        ...
        if (empty($title) or empty($image) or empty($thumbnail)){
            ...
            $query = $pdo->prepare('INSERT INTO images_scene (image_alt, image_content, image_thumbnail) VALUES (?, ?, ?)');
...
?>
    <html>
        ...
        <div id="loginPageContainer">
            ...
            <h2>Ajouter une Image Scene</h2>
                <div class="form-group column col-md-10 ">
                    <form action="addSceneImage.php" method="post"  enctype="multipart/form-data">
